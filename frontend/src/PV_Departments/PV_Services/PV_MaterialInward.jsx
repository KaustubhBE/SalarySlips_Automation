...
const PV_MaterialInward = () => {
  ...
  const fetchPartyPlaceData = async () => {
    try {
      ...
      // Find the Padmavati plant data to get the sheet ID
      const padmavatiPlant = PLANT_DATA.find(plant => plant.document_name === 'PV')
      const sheetId = padmavatiPlant?.material_sheet_id
      
      if (!sheetId) {
        console.error('No sheet ID found for Padmavati plant')
        setMessage('No Google Sheet configuration found for Padmavati plant')
  ...
  return (
    <div className="place_order-container">
      ...
      <div style={{ 
        ...
        <button 
          onClick={() => navigate('/padmavati/kr_store')} 
...
export default PV_MaterialInward