...
function Processing({ mode = 'single' }) {
  ...
  const hasProcessingPermission = () => {
    ...
    const requiredPermission = mode === 'single' ? 'om_single_processing' : 'om_batch_processing';
    return hasPermission(requiredPermission, 'omkar', 'humanresource');
  };
      ...
      <Routes>
        ...
        <Route path="" element={
          <div className="input-elements">
            ...
            <BackButton label="Back to Department" to="/omkar/om_humanresource" />
            {mode === 'single' && (
              <>
